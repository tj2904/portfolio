...
const projectList: Projects = [
  ...
  //   slug: 'random-forests-housing-typologies',
  //   title: 'Predicting Houseing Typologies using Random Forests',
  //   description:
  //     'A end-to-end pipeline for the daily training of a Random Forest and batch predictions.',
  //   image: '',
  //   link: '',
  //   repo: '',
  //   rational: '',
  ...
  //     { tech: 'Shapely' },
  //   ],
  //   deployment: [{ tech: 'Google Cloud Platform' }, { tech: 'GCP Vertex AI' }],
  // },
  // {
  //   id: ,
  //   type: '',
